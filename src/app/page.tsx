...
function CandleWithLabel({ label, data }: { label: string, data: any }) {
  return (
    <div className="flex flex-col items-center gap-4">
      <span className="text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest bg-slate-200/50 dark:bg-slate-800 px-2 py-1 rounded-md">
        {label}
      </span>
      {data ? (
        <VisualCandle 
